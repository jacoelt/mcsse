...
class MinecraftMpFetcher(ServerFetcherBase):
    server_list_url = "https://minecraft-mp.com/servers/list/{page_number}/"
    individual_server_url = "https://minecraft-mp.com/server-{server_id}"
    max_page_number = 322
